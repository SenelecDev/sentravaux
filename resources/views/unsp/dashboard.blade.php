...
@section('title', 'Tableau de bord UNSP')

@section('content')
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tableau de bord UNSP</h1>
        <p class="mt-1 text-gray-500">Suivi des demandes UNSP</p>
    </div>
    ...
    <div class="card">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            <a href="{{ route('unsp.demandes.recues') }}" class="quick-action">
            ...
            <a href="{{ route('unsp.demandes.validees') }}" class="quick-action">
            ...
            <a href="{{ route('unsp.demandes.debutees') }}" class="quick-action">
                <svg class="quick-action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <span class="text-sm text-gray-600">Débutées</span>
            </a>
            <a href="{{ route('unsp.demandes.terminees') }}" class="quick-action">
            ...
            <a href="{{ route('unsp.demandes.cloturees') }}" class="quick-action">
