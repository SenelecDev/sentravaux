...
<div class="space-y-6">
    ...
    <form method="GET" class="card-senelec p-4 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="md:col-span-4 flex gap-2">
            ...
            <a href="{{ route('seg.dashboard') }}" class="btn-secondary text-sm">Reinitialiser</a>
            <a href="{{ route('seg.dashboard.export', request()->query()) }}" class="btn-warning text-sm">Exporter</a>
        </div>
    </form>
