...
@section('title', 'Demandes approuvées')

@section('content')
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Demandes approuvées</h1>
    ...
    <div class="card-senelec">
        <div class="flex flex-wrap gap-2">
            @foreach($statutsDisponibles as $code => $label)
                @php $isActive = ($statut ?? 'accepte') === $code; @endphp
                <a href="{{ route('demande.demandes_approuvees', ['statut' => $code]) }}"
