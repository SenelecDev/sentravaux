...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tableau de bord Demandeur</h1>
            <p class="mt-1 text-gray-500">Suivi de vos demandes de travaux</p>
        </div>
    ...
    {{-- Filtres mois/année + résumé visuel --}}
    <div class="card-senelec">
        ...
        <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
            ...
            <div class="flex items-center justify-center">
                <div class="w-64 h-64">
                    <canvas id="demandeurDonut"></canvas>
                </div>
            </div>
        ...
        <div class="p-6">
            <div class="w-full overflow-x-auto">
                <div class="min-w-[700px]">
                    <canvas id="demandeurLine" height="120"></canvas>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('demande.create') }}" class="quick-action">
                <svg class="quick-action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                <span class="text-sm text-gray-600">Nouvelle demande</span>
            </a>
            <a href="{{ route('demande.index') }}" class="quick-action">
...
<script>
    (function () {
        ...
        const donutCtx = document.getElementById('demandeurDonut')?.getContext('2d');
        if (donutCtx) {
            new Chart(donutCtx, {
                type: 'doughnut',
                data: {
        ...
        const lineCtx = document.getElementById('demandeurLine')?.getContext('2d');
        if (lineCtx) {
