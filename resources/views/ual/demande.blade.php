@extends('layouts.app')
@section('title', $title ?? 'Demandes UAL')
@section('content')
<div class="space-y-4">
    <h1 class="text-2xl font-bold text-gray-900">{{ $title ?? 'Demandes UAL' }}</h1>
            ...
            @forelse($demandes as $demande)
                ...
                <tr>
                    ...
                    <td class="flex items-center gap-2">
                        ...
                        @else
                            <a href="{{ route('ual.edit', $demande) }}" class="btn-secondary text-xs">Traiter</a>
                        @endif
                    </td>
                </tr>
            @empty
