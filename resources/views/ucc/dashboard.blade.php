...
@section('title', 'Tableau de bord UCC')

@section('content')
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Tableau de bord UCC</h1>
        <p class="mt-1 text-gray-500">Suivi des demandes UCC</p>
    </div>
    ...
    <div class="card">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            <a href="{{ route('ucc.demandes.recues') }}" class="quick-action"><span class="text-sm text-gray-600">Demandes reçues</span></a>
            <a href="{{ route('ucc.demandes.validees') }}" class="quick-action"><span class="text-sm text-gray-600">Validées</span></a>
            <a href="{{ route('ucc.demandes.debutees') }}" class="quick-action"><span class="text-sm text-gray-600">Débutées</span></a>
            <a href="{{ route('ucc.demandes.terminees') }}" class="quick-action"><span class="text-sm text-gray-600">Terminées</span></a>
            <a href="{{ route('ucc.demandes.cloturees') }}" class="quick-action"><span class="text-sm text-gray-600">Clôturées</span></a>
        </div>
    </div>
</div>
@endsection
